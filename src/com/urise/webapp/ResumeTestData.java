...
public class ResumeTestData {
    ...
    public static Resume createResume(String uuid, String fullName){
        ...
        List<Organization.Position> javaOnlineProjects= new ArrayList<>();
        javaOnlineProjects.add(new Organization.Position("Автор проекта.", "Создание, организация и проведение Java онлайн проектов и стажировок", LocalDate.of(2013, Month.OCTOBER, 1), LocalDate.of(2021, Month.MAY, 1)));
        List<Organization.Position> luxoft= new ArrayList<>();
        luxoft.add(new Organization.Position("Ведущий программист", "Участие в проекте Deutsche Bank CRM (WebLogic, Hibernate, Spring, Spring MVC, SmartGWT, GWT, Jasper, Oracle). Реализация клиентской и серверной части CRM. Реализация RIA-приложения для администрирования, мониторинга и анализа результатов в области алгоритмического трейдинга. JPA, Spring, Spring-MVC, GWT, ExtGWT (GXT), Highstock, Commet, HTML5.", LocalDate.of(2010, Month.DECEMBER, 1), LocalDate.of(2012, Month.APRIL, 1)));
        List<Organization.Position> wrike= new ArrayList<>();
        wrike.add(new Organization.Position("Старший разработчик (backend)", "Проектирование и разработка онлайн платформы управления проектами Wrike (Java 8 API, Maven, Spring, MyBatis, Guava, Vaadin, PostgreSQL, Redis). Двухфакторная аутентификация, авторизация по OAuth1, OAuth2, JWT SSO.", LocalDate.of(2014, Month.OCTOBER, 1), LocalDate.of(2017, Month.JANUARY, 1)));
        List<Organization.Position> yota= new ArrayList<>();
        yota.add(new Organization.Position("Ведущий специалист", "Дизайн и имплементация Java EE фреймворка для отдела \"Платежные Системы\" (GlassFish v2.1, v3, OC4J, EJB3, JAX-WS RI 2.1, Servlet 2.4, JSP, JMX, JMS, Maven2). Реализация администрирования, статистики и мониторинга фреймворка. Разработка online JMX клиента (Python/ Jython, Django, ExtJS)", LocalDate.of(2008, Month.JUNE, 1), LocalDate.of(2010, Month.DECEMBER, 1)));
        List<Organization.Position> enkata= new ArrayList<>();
        enkata.add(new Organization.Position( "Разработчик ПО", "Реализация клиентской (Eclipse RCP) и серверной (JBoss 4.2, Hibernate 3.0, Tomcat, JMS) частей кластерного J2EE приложения (OLAP, Data mining).", LocalDate.of(2007, Month.MARCH, 1), LocalDate.of(2008, Month.MAY, 1)));
        List<Organization.Position> siemens = new ArrayList<>();
        siemens.add(new Organization.Position("Разработчик ПО", "Разработка информационной модели, проектирование интерфейсов, реализация и отладка ПО на мобильной IN платформе Siemens @vantage (Java, Unix).", LocalDate.of(2005, Month.JANUARY, 1), LocalDate.of(2007, Month.DECEMBER, 1)));
        List<Organization.Position> alcatel = new ArrayList<>();
        alcatel.add(new Organization.Position("Инженер по аппаратному и программному тестированию", "Тестирование, отладка, внедрение ПО цифровой телефонной станции Alcatel 1000 S12 (CHILL, ASM).", LocalDate.of(1997, Month.SEPTEMBER, 1), LocalDate.of(2005, Month.JANUARY, 1)));
        ...
        List<Organization.Position> coursera = new ArrayList<>();
        coursera.add( new Organization.Position("Student", "\"Functional Programming Principles in Scala\" by Martin Odersky", LocalDate.of(2013, Month.MARCH, 1), LocalDate.of(2013, Month.MAY, 1)));
        List<Organization.Position> siemensEd = new ArrayList<>();
        siemensEd.add( new Organization.Position("Student","3 месяца обучения мобильным IN сетям (Берлин)", LocalDate.of(2005, Month.JANUARY, 1), LocalDate.of(2005, Month.APRIL, 1)));
        List<Organization.Position> luxoftEd = new ArrayList<>();
        luxoftEd.add(new Organization.Position( "Student", "Курс \"Объектно-ориентированный анализ ИС. Концептуальное моделирование на UML.\"", LocalDate.of(2011, Month.MARCH, 1), LocalDate.of(2011, Month.APRIL, 1)));
        List<Organization.Position> alcatelEd = new ArrayList<>();
        alcatelEd.add(new Organization.Position("Student", "6 месяцев обучения цифровым телефонным сетям (Москва)", LocalDate.of(1997, Month.SEPTEMBER, 1), LocalDate.of(1998, Month.MARCH, 1)));
        List<Organization.Position> university = new ArrayList<>();
        university.add(new Organization.Position("Student", "Аспирантура (программист С, С++)", LocalDate.of(1993, Month.SEPTEMBER, 1), LocalDate.of(1996, Month.JULY, 1)));
        university.add(new Organization.Position( "Student", "Инженер (программист Fortran, C)", LocalDate.of(1987, Month.SEPTEMBER, 1), LocalDate.of(1993, Month.JULY, 1)));
        List<Organization.Position> school = new ArrayList<>();
        school.add(new Organization.Position( "Student", "Закончил с отличием", LocalDate.of(1984, Month.SEPTEMBER, 1), LocalDate.of(1987, Month.JUNE, 1)));
